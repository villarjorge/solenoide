...
auto main() -> int {
    ...
    std::cout<<"Insert the path of the CSV file (C:/Users/user_name/Desktop/file_name.csv): "; std::cin>>Path; // Preguntamos al usuario por el camino y lo guardamos en Path
